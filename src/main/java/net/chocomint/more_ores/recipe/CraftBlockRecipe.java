...
public class CraftBlockRecipe implements Recipe<SimpleInventory> {
	public enum Weather {
	CLEAR,
	RAIN,
	THUNDERING;
	...
	public CraftBlockRecipe(Identifier id, ItemStack output,
	...
	public static class Type implements RecipeType<CraftBlockRecipe> {
		private Type() { }
		public static final Type INSTANCE = new Type();
		public static final String ID = "lightning";
	}

	public static class Serializer implements RecipeSerializer<CraftBlockRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		public static final String ID = "lightning";
		// this is the name given in the json file

		@Override
		public CraftBlockRecipe read(Identifier id, JsonObject json) {
			...
			return new CraftBlockRecipe(id, output,
					inputs, Weather.getWeatherByString(weather));
		}

		@Override
		public CraftBlockRecipe read(Identifier id, PacketByteBuf buf) {
		...
		@Override
		public void write(PacketByteBuf buf, CraftBlockRecipe recipe) {
